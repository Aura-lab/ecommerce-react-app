...
let zodiacObj = [
  {
      ...
      image:"http://www.bzodiac.com/wp-content/uploads/2010/09/rat.gif"
  },
  {
      id:1,
      name:"ox",
      ...
      image:"http://www.bzodiac.com/wp-content/uploads/2010/09/ox.gif"
  },
  {
      id:2,
      name:"tiger",
      ...
      image:'http://www.bzodiac.com/wp-content/uploads/2010/09/tiger.gif'
  },
  {
      id:3,
      name:"rabbit",
      ...
      image:"http://www.bzodiac.com/wp-content/uploads/2010/09/hare.gif"
  },
  {
      id:4,
      name:"dragon",
      ...
      image:"http://www.bzodiac.com/wp-content/uploads/2010/09/dragon.gif"
  },
  {
      id:5,
      name:"snake",
      ...
      image:"http://www.bzodiac.com/wp-content/uploads/2010/09/snake.gif"
  },
  {
      id:6,
      name:"horse",
      ...
      image:"http://www.bzodiac.com/wp-content/uploads/2010/09/horse.gif"
  },
  {
      id:7,
      name:"goat",
      ...
      image:"http://www.bzodiac.com/wp-content/uploads/2010/09/sheep.gif"
  },
  {
      id:8,
      name:"monkey",
      ...
      image:"http://www.bzodiac.com/wp-content/uploads/2010/09/monkey.gif"
  },
  {
      id:9,
      name:"rooster",
      ...
      image:"http://www.bzodiac.com/wp-content/uploads/2010/09/rooster.gif"
  },
  {
      id:10,
      name:"dog",
      ...
      image:"http://www.bzodiac.com/wp-content/uploads/2010/09/dog.gif"
  },
  {
      id:11,
      name:"pig",
      ...
      image:"http://www.bzodiac.com/wp-content/uploads/2010/09/boar.gif"
  }
]
...
function Zodiac(props) {
  ...
  useEffect(() => {
    request(zodiacUrl).then(response => response.json()).then(res => {
      console.log(res);
      setZodiac(res);
    });
  }, []);
